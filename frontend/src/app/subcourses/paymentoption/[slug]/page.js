...
import { ChevronDown, Check, CreditCard, Smartphone, Zap, ArrowLeft, Star, Clock, Users, Book, AlertCircle } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-8">
            ...
            {/* Form continues with all the fields... */}
...
// const DynamicPaymentPage = ({ params }) => {
//   // Step 1: Unwrap the params Promise using React.use()
//   const unwrappedParams = use(params);
...
//   // Step 2: Use the unwrapped params in useEffect
//   useEffect(() => {
//     if (unwrappedParams?.slug) {
//       fetchCourse(unwrappedParams.slug);
//     }
...
//     // Validation code check (simple check for demo)
//     if (formData.validation_code.toLowerCase() !== 'm2nz') {
//       setError('Please enter the correct validation code');
//       return false;
//     }
...
//                 {/* Course Image and Pricing */}
//                 <div className="lg:w-80 mt-6 lg:mt-0">
//                   <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
//                     <div className="w-full h-40 mb-4 rounded-lg overflow-hidden">
//                       <img 
//                         src={currentCourse.image_url || '/api/placeholder/320/160'} 
//                         alt={currentCourse.title}
//                         className="w-full h-full object-cover"
//                         onError={(e) => {
...
//                       />
//                       <div 
//                         className="w-full h-full bg-gradient-to-br from-white/20 to-white/5 rounded-lg flex items-center justify-center"
//                         style={{ display: 'none' }}
//                       >
//                         <span className="text-white font-semibold">{currentCourse.category}</span>
//                       </div>
//                     </div>
//                     <div className="text-center">
//                       <div className="text-3xl font-bold text-white mb-2">₹{currentCourse.total_amount}</div>
...
//         {/* Course Features */}
//         {currentCourse && currentCourse.features && currentCourse.features.length > 0 && (
//           <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
//             <h3 className="text-lg font-semibold text-gray-800 mb-4">What You'll Learn</h3>
//             <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
//               {currentCourse.features.map((feature, index) => (
