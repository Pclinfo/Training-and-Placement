...
// Note: Make sure your backend endpoint /api/project-enrollments is set up correctly
// The FormData should include: project_slug, name, email, mobile, team_size, 
// preferred_start_date, preferred_time, payment_method, validation_code, 
// and payment_screenshot (file)
...
// // Mock params for demo - replace with actual params in your app
// const mockParams = { slug: 'full-stack-web-app' };

// const DynamicProjectPaymentPage = ({ params = mockParams }) => {
//   const [selectedOption, setSelectedOption] = useState('neft');
//   const [currentProject, setCurrentProject] = useState(null);
...
//       detailed_description: 'Learn to build a full-stack e-commerce application with modern technologies including React, Node.js, and MongoDB.',
...
//       learning_outcomes: ['Build REST APIs', 'Implement authentication', 'Deploy applications'],
//       image_url: null,
...
//     // Simulate API call
//     setTimeout(() => {
//       setSuccess('Enrollment submitted successfully! Enrollment ID: PROJ_ENR_ABC123');
//       setSubmitting(false);
//       window.scrollTo({ top: 0, behavior: 'smooth' });
//     }, 1500);
//   };
...
//                   <div className="flex items-center">
//                     <Users className="w-4 h-4 mr-2" />
//                     <span>{currentProject.total_enrollments} Enrolled</span>
//                   </div>
//                   {currentProject.rating && (
//                     <div className="flex items-center">
//                       <Star className="w-4 h-4 mr-1 fill-yellow-400 text-yellow-400" />
...
// // import { ChevronDown, Check, CreditCard, Smartphone, Zap, ArrowLeft, Clock, Users, Code, AlertCircle, Layers } from 'lucide-react';
...
// //       fetchProject(unwrappedParams.slug);
// //     }
...
// //     try {
// //       const response = await fetch(`http://localhost:7000/api/projects/${slug}`);
// //       const data = await response.json();
...
// //       const response = await fetch('http://localhost:7000/api/project-enrollments', {
// //         method: 'POST',
// //         headers: {
...
// //       if (data.success) {
// //         setSuccess(`Enrollment request submitted successfully! Enrollment ID: ${data.enrollment_id}. You will receive a confirmation email shortly.`);
// //         setFormData({
// //           name: '',
// //           email: '',
// //           mobile: '',
...
// //           <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded">
// //             <p className="text-sm text-yellow-800">
// //               <strong>Note:</strong> After making the payment, please submit this form to complete your enrollment.
// //             </p>
// //           </div>
// //         </div>
// //       );
...
// //   if (error && !currentProject && !success) {
// //     return (
// //       <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 flex items-center justify-center">
// //         <div className="text-center">
...
// //                       <span className="capitalize">{currentProject.project_type} Project</span>
// //                     </div>
// //                   </div>
// //                 </div>
...
// //                       {!imageError && currentProject.image_url ? (
// //                         <img 
...
// //                           <div className="text-center">
// //                             <Code className="w-12 h-12 text-white/70 mx-auto mb-2" />
// //                             <span className="text-white font-semibold text-sm">{currentProject.category}</span>
// //                           </div>
// //                         </div>
// //                       )}
// //                     </div>
// //                     <div className="text-center">
// //                       <div className="text-sm text-blue-200 mb-2">Project Code</div>
// //                       <div className="text-xl font-bold text-white">{currentProject.project_code}</div>
// //                     </div>
// //                   </div>
// //                 </div>
// //               </div>
...
// //                   {currentProject.prerequisites.map((prereq, index) => (
...
// //         {/* Learning Outcomes */}
// //         {currentProject && currentProject.learning_outcomes && currentProject.learning_outcomes.length > 0 && (
// //           <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
// //             <h3 className="text-lg font-semibold text-gray-800 mb-4">What You'll Learn</h3>
// //             <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
// //               {currentProject.learning_outcomes.map((outcome, index) => (
// //                 <div key={index} className="flex items-start">
...
// //                     <label className="block text-sm font-medium text-gray-700 mb-2">Billing Address</label>
// //                     <textarea
// //                       className="text-black w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent h-24"
// //                       value={formData.billing_address}
// //                       onChange={(e) => handleInputChange('billing_address', e.target.value)}
// //                     />
// //                   </div>
...
// //               <div className="bg-gray-50 rounded-xl p-6">
// //                 <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center">
// //                   <div className="w-8 h-8 bg-purple-500 text-white rounded-full flex items-center justify-center text-sm font-bold mr-3">4</div>
// //                   Validation Code
// //                 </h3>
// //                 <div className="flex items-center space-x-4">
// //                   <div className="bg-white p-3 border-2 border-dashed border-gray-300 rounded-lg">
...
// //                 <div className="bg-gray-50 rounded-xl p-6">
// //                   <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center">
// //                     <div className="w-8 h-8 bg-purple-500 text-white rounded-full flex items-center justify-center text-sm font-bold mr-3">5</div>
// //                     Enrollment Summary
// //                   </h3>
// //                   <div className="space-y-3 text-sm">
// //                     <div className="flex justify-between">
// //                       <span className="font-medium text-gray-700">Project Name:</span>
// //                       <span className="text-gray-800">{currentProject.title}</span>
// //                     </div>
// //                     <div className="flex justify-between">
// //                       <span className="font-medium text-gray-700">Project Code:</span>
// //                       <span className="text-gray-800">{currentProject.project_code}</span>
// //                     </div>
// //                     <div className="flex justify-between">
// //                       <span className="font-medium text-gray-700">Duration:</span>
// //                       <span className="text-gray-800">{currentProject.duration}</span>
// //                     </div>
// //                     <div className="flex justify-between">
// //                       <span className="font-medium text-gray-700">Difficulty:</span>
// //                       <span className="text-gray-800">{currentProject.difficulty_level}</span>
// //                     </div>
// //                     <div className="flex justify-between">
// //                       <span className="font-medium text-gray-700">Project Type:</span>
// //                       <span className="text-gray-800 capitalize">{currentProject.project_type}</span>
// //                     </div>
// //                     <div className="flex justify-between">
...
// //                   type="submit"
// //                   disabled={submitting}
// //                   className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-bold py-4 px-12 rounded-xl transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center space-x-2 shadow-lg"
// //                 >
// //                   {submitting ? (
// //                     <>
// //                       <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white"></div>
...
// //               <span>After submitting the enrollment form, you will receive a confirmation email with project details and next steps.</span>
// //             </li>
// //             <li className="flex items-start">
// //               <span className="text-blue-600 mr-2">•</span>
// //               <span>If you selected NEFT or GPay, please complete the payment and share the transaction details via email to complete your enrollment.</span>
// //             </li>
// //             <li className="flex items-start">
// //               <span className="text-blue-600 mr-2">•</span>
// //               <span>Our team will verify your enrollment and contact you within 24-48 hours to schedule your project kickoff.</span>
// //             </li>
// //             <li className="flex items-start">
// //               <span className="text-blue-600 mr-2">•</span>
// //               <span>For any queries, please contact our support team at support@pclinfotech.com or call +91-XXXXXXXXXX.</span>
// //             </li>
// //           </ul>
// //         </div>
// //       </div>
